...
async function main() {
  ...
  // const levels = await proxyUpdate.connect(yurii).levels(3423);
  // console.log('level of 3423: ', levels);
  // const experience = await proxyUpdate.connect(yurii).experience(3423);
  // console.log('experience of 3423: ', parseInt(experience._hex, 16));
