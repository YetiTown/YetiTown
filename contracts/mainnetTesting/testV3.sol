...
contract V3YetiGameLogic is  Ownable, IERC721Receiver, rarityCheck, Initializable, Pausable {
    ...
    function initiateGameAt (uint tokenId, uint rarity) external {
